...
if (!strcmp($sub, "products_edit")) {
    ...
    if (isset($_POST["save_product"])) {
        ...
        if ($_POST["enable_autores"] == 1) {
            if (isset($_FILES["picture"]) && $_FILES["picture"]["name"] && preg_match('/\.(jpg|jpeg|gif|png)$/i', $_FILES["picture"]["name"],$fend)) {
                ...
                img_resize("./products_pictures/" . $_FILES["picture"]["name"], "./products_pictures/" . $new_pic_name . $fend[0], RESIZE_NORMAL_X, RESIZE_NORMAL_Y, CONF_IMAGE_COLOR);
                img_resize("./products_pictures/" . $_FILES["picture"]["name"], "./products_pictures/" . $new_pic_name . '-S'.$fend[0], RESIZE_SMALL_X, RESIZE_SMALL_Y, CONF_IMAGE_COLOR);
                img_resize("./products_pictures/" . $_FILES["picture"]["name"], "./products_pictures/" . $new_pic_name . "-B".$fend[0], RESIZE_BIG_X, RESIZE_BIG_Y, CONF_IMAGE_COLOR);
                img_resize("./products_pictures/" . $_FILES["picture"]["name"], "./products_pictures/" . $new_pic_name . "-H".$fend[0], 130, 130, CONF_IMAGE_COLOR);
                img_resize("./products_pictures/" . $_FILES["picture"]["name"], "./products_pictures/" . $new_pic_name . "-SC".$fend[0], 50, 50, CONF_IMAGE_COLOR);
                $updateproduct['picture']     = $new_pic_name . $fend[0];
                $updateproduct['thumbnail']   = $new_pic_name . "-S".$fend[0];
                $updateproduct['big_picture'] = $new_pic_name . "-B".$fend[0];
