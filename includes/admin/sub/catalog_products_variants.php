...
if (!strcmp($sub, "products_variants"))
{
    ...
    { 
      ...
      db_query("delete from ".PRODUCT_OPTIONS_VAL_TABLE." where  optionID=".$_GET['del']);
      db_query("delete from ".PRODUCT_OPTIONS_V_TABLE." where  optionID=".$_GET['del']);
    ...
    {  
       ...
       db_query("delete from ".PRODUCT_OPTIONS_V_TABLE." where  variantID=".$_GET['del']);
