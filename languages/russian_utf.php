...
define('ADMIN_VOTES_EDIT','Редактирование голосования');
define('ADMIN_VOTES_ADD','Редактирование голосования');
//admin
...
define('ADMIN_SHIPPING_ADD', 'Добавить способ доставки');
...
define('ADMIN_IMPORT_NEW', 'Добавить только новые товары в каталог');
define('ADMIN_IMPORT_UPDATE', 'Обновить все товары в каталоге');
define('ADMIN_IMPORT_UPDATE_PES','Обновить поля у существующих товаров (Отметьте поля, которые требуют обновления)');
...
define('NEW_BUYERS','Новые покупатели'); 
...
define('Licenzia', 'Лицензионное соглашение');
define('licenz_yes','Я соглашаюсь с условиями данного лицензионного соглашения.');
define('download_lego','Скачать Shop Script LegoSP 6.1');
